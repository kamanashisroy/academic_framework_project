...
public class DefaultAccountDialog extends javax.swing.JDialog {
	IModuleFactory factory = null;

	public DefaultAccountDialog(IModuleFactory factory) {
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
		...
		ICustomer customer = factory.getCustomerFactory().createCustomer(name);
